...
const DRAG_STYLEBOX := preload("uid://b2tuucubn76j3")
...
func _ready() -> void:
	EventManager.card_drag_started.connect(_on_card_drag_or_aiming_started)
	EventManager.card_drag_ended.connect(_on_card_drag_or_aim_ended)
	EventManager.card_aim_started.connect(_on_card_drag_or_aiming_started)
	EventManager.card_aim_ended.connect(_on_card_drag_or_aim_ended)
...
func request_tooltip() -> void:
	...
	EventManager.card_tooltip_requested.emit(card.icon, updated_tooltip)
