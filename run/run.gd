...
const BATTLE_REWARD_SCENE := preload("res://battle_rewards/battle_reward.tscn")
const CAMPFIRE_SCENE := preload("res://campfire/campfire.tscn")
const MAP_SCENE := preload("res://map/map.tscn")
const SHOP_SCENE := preload("res://shop/shop.tscn")
const TREASURE_SCENE := preload("res://treasure/treasure.tscn")
